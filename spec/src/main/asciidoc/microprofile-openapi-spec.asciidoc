...
The MP OpenAPI specification does not mandate but recommend vendors to support https://www.w3.org/TR/cors/[CORS]
for the `/openapi` endpoint.  Without the CORS support, the tools such as Swagger-UI might experience some errors. 

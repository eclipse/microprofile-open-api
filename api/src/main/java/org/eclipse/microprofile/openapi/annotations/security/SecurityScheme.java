...
/**
 * Defines a security scheme that can be used by the operations. Supported schemes are HTTP authentication, an API key (either as a header or as a
 * query parameter), OAuth2's common flows (implicit, password, application and access code) as defined in RFC6749, and OpenID Connect Discovery.
 **/
...
public @interface SecurityScheme {
    ...
    /**
     * Name is a REQUIRED property for apiKey type. It is the name of the header, query or cookie parameter to be used. Applies to apiKey type.
     * 
    ...
    /**
     * The location of the API key. Valid values are "query" or "header". A REQUIRED property for apiKey type.
     * 
    ...
    /**
     * The name of the HTTP Authorization scheme to be used in the Authorization header as defined in RFC 7235. A REQUIRED property for http type.
     * 
     ...
     * information is primarily for documentation purposes. Applies to http ("bearer") type.
     * 
    ...
    /**
     * This is a REQUIRED property for oauth2 type. An object containing configuration information for the flow types supported.
     * 
    ...
    /**
     * This is a REQUIRED property for openIdConnect type. OpenId Connect URL to discover OAuth2 configuration values. This MUST be in the form of a
     * URL.
     * 

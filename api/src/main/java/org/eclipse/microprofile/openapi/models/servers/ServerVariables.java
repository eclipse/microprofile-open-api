 ...
 * @deprecated since 1.1, a future version will remove this and replace it with a <code>Map<String, ServerVariable></code>, because it does not need to be extensible
 */
@Deprecated

...
public interface IntegerSchema extends Schema<Integer> {
    ...
    /**
     * Change this IntegerSchema's type property from the default value to the given string.
     *
    ...
    /**
     * Change this IntegerSchema's format property from the default value to the given format. The value may be one of the formats described in the

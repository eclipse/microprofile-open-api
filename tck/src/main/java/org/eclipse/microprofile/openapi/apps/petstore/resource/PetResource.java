...
import iorg.eclipse.microprofile.openapi.annotations.media.ExampleObject;
...
public class PetResource {
  ...
  @Operation(
		  ...
		  If ID is greater than 10 or nonintegers, will simulate API error conditions",
		  responses = {
				  @APIResponse(
						  responseCode = "400",
  ...
  @Operation(
		  ...
		  description = "Find all the Pets with the given status; 
